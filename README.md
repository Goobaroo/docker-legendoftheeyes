...
The docker on first run will download the same version as tagged of FTB Legend of the Eyes and install it.  This can take a while as the Forge installer can take a bit to complete.  You can watch the logs and it will eventually finish.
...
* MOTD "FTB Legend of the Eyes Server Powered by Docker"
* LEVEL world
...
## Source
Github: https://github.com/Goobaroo/docker-legendoftheeyes

Docker: https://hub.docker.com/repository/docker/goobaroo/legendoftheeyes